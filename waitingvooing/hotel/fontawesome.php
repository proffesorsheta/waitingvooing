...
<!-- Mirrored from thevectorlab.net/slicklab/fontawesome.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Feb 2020 06:26:40 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <section>
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="menu-list nav-active"><a href="#"><i class="fa fa-book"></i> <span>UI Elements</span></a>
                        <ul class="child-list">
                            ...
                            <li class="active"><a href="fontawesome.html"> Fontawesome</a></li>
        ...
        <div class="body-content" style="min-height: 1000px;">
            ...
            <div class="page-head">
                ...
                <span class="sub-title">Font Awesome gives you scalable vector icons that can instantly be customized — size, color, drop shadow, and anything that can be done with the power of CSS.</span>
            </div>
            <!-- page head end-->
            ...
            <div class="row fontawesome-list">
